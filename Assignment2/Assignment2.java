...
public class Assignment2 {
    ...
    static boolean wordContainsLetter (String a, char b){
        String s1 = a;
    ...
    static boolean wordContainsString(String a, String b) {
        return a.contains(b);
    }

    static void guessWordWithLetters(English words, int b, String c){
        char[] charArray = c.toCharArray();
        for(String word: words.words){

            boolean containsAll = true;
            for (char c1 : charArray){
                containsAll = wordContainsLetter(word,c1);
                if(!containsAll){
                    break;
                }
            }
            if (containsAll && word.length() == b){
                System.out.println(word);
            }
        }
    }

    static void guessWordWithPattern(English words, int b, String c){

        for (String word: words.words){
            boolean contains = true;
            contains = wordContainsString(word, c);
            if (contains && word.length() == b){
                System.out.println(word);
            }
        }
    }
    ...
    public static void main (String[] args){
        ...
        if (selection == 1){
            ...
            String wordSearch = scanning.nextLine();
            System.out.println("It might be any of these...");
            guessWordWithLetters(words, numLetters, wordSearch);
                /*for (String s1 : words){
                    boolean found = wordContainsLetter(s1,desired);
                    if (found){
            ...
            /*else {
                System.out.println("It might be any of these...");
                char[] charArray = wordSearch.toCharArray();
                    for(String s1: words){
                        boolean good = true;
                        for (char c1: charArray){
                            boolean found = wordContainsLetter(s1,c1);
                            if(!found){
                                good = false;
                                break;
                            }
            ...
            String pattern = scanning.nextLine();
            System.out.println("It might be any of these...");
            guessWordWithPattern(words, numLetters, pattern);
        }
    }
}
